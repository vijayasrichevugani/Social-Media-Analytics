...
target_num = 15
query = "jurasicworldfallenkingdom"

csvFile = open('jurasicworldfallenkingdom.csv','w')
...
csvFile.close()
positive =percentages(positive,target_num)
negative =percentages(negative,target_num)
neutral =percentages(neutral,target_num)
...
plt.title("sentimental analysis on One Plus 6")
plt.axis('equal')
plt.tight_layout()
plt.show()
