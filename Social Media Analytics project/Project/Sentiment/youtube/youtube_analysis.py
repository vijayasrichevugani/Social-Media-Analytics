...
youtube_data = pd.read_csv('kaala.csv')
positive =percentages(sum(youtube_data.positive),10)
negative =percentages(sum(youtube_data.negative),10)
neutral =percentages(sum(youtube_data.neutral),10)
...
plt.title("sentimental analysis on kaala")
plt.axis('equal')
plt.tight_layout()
plt.show()
# =============================================================================
